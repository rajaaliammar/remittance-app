...
import portalSettingRoutes from './portalSetting.routes.js';
import kycRoutes from './kyc.routes.js';
import messageRoutes from './message.routes.js';
import faqRoutes from './faq.routes.js';
import legalDocumentRoutes from './legalDocument.routes.js';
...
router.use('/portal-settings', portalSettingRoutes);
