...
const DEFAULT_RECEIPT_SETTINGS = {
  ...
  logoUrl: '',
  companyAddress: '860 Blue Gentian Rd. Suite 200, Eagan, MN 55121',
  companyPhone: '+1-855-626-7031',
  companyEmail: 'support@onezapay.com',
  ...
  mobilePdfLogoUrl: '',
  mobilePdfBrandName: 'OneZaPay',
  mobilePdfBrandSubTitle: 'Powered by Beeso',
  mobilePdfReceiptTitle: 'Payment Receipt',
  mobilePdfCompanyAddress: '860 Blue Gentian Rd. Suite 200, Eagan, MN 55121',
  mobilePdfCompanyPhone: '+1-855-626-7031',
  mobilePdfCompanyEmail: 'support@onezapay.com',
...
const ensureReceiptSettingsTable = async () => {
  await prisma.$executeRawUnsafe(`
    CREATE TABLE IF NOT EXISTS "receipt_settings" (
      "id" TEXT NOT NULL,
      "brandName" TEXT NOT NULL DEFAULT 'OneZaPay',
      ...
      "companyEmail" TEXT NOT NULL DEFAULT 'support@onezapay.com',
      ...
      "mobilePdfBrandName" TEXT NOT NULL DEFAULT 'OneZaPay',
      ...
      "mobilePdfCompanyEmail" TEXT NOT NULL DEFAULT 'support@onezapay.com',
  ...
  await prisma.$executeRawUnsafe(`
    ...
    ADD COLUMN IF NOT EXISTS "mobilePdfBrandName" TEXT NOT NULL DEFAULT 'OneZaPay',
    ...
    ADD COLUMN IF NOT EXISTS "mobilePdfCompanyEmail" TEXT NOT NULL DEFAULT 'support@onezapay.com',
    ...
    ADD COLUMN IF NOT EXISTS "disclosureInstitution" TEXT NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS "disclosurePhone" TEXT NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS "disclosureWebsite" TEXT NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS "disclosureEmail" TEXT NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS "disclosureAddress" TEXT NOT NULL DEFAULT ''
  `);
};
  ...
  await prisma.$executeRawUnsafe(
    `
      INSERT INTO "receipt_settings" (
        ...
        "disclosureInstitution", "disclosurePhone", "disclosureWebsite",
        "disclosureEmail", "disclosureAddress",
        "mobileRightsTitle",
    ...
    DEFAULT_RECEIPT_SETTINGS.disclosureInstitution,
    DEFAULT_RECEIPT_SETTINGS.disclosurePhone,
    DEFAULT_RECEIPT_SETTINGS.disclosureWebsite,
    DEFAULT_RECEIPT_SETTINGS.disclosureEmail,
    DEFAULT_RECEIPT_SETTINGS.disclosureAddress,
    ...
    await prisma.$executeRawUnsafe(
      `
        ...
        SET "brandName" = $1,
            ...
            "disclosureTitle" = $9,
            "disclosureText" = $10,
            "disclosureInstitution" = $11,
            "disclosurePhone" = $12,
            "disclosureWebsite" = $13,
            "disclosureEmail" = $14,
            "disclosureAddress" = $15,
            "mobileRightsTitle" = $16,
            "mobileRightsIntro" = $17,
            "mobileScamTitle" = $18,
            "mobileScamBullets" = $19,
            "mobileRightsFooter" = $20,
            "mobilePdfLogoUrl" = $21,
            "mobilePdfBrandName" = $22,
            "mobilePdfBrandSubTitle" = $23,
            "mobilePdfReceiptTitle" = $24,
            "mobilePdfCompanyAddress" = $25,
            "mobilePdfCompanyPhone" = $26,
            "mobilePdfCompanyEmail" = $27,
            "mobilePdfNoteText" = $28,
            "updatedAt" = NOW()
        WHERE "id" = $29
      `,
      next.brandName,
      ...
      next.disclosureText,
      next.disclosureInstitution,
      next.disclosurePhone,
      next.disclosureWebsite,
      next.disclosureEmail,
      next.disclosureAddress,
