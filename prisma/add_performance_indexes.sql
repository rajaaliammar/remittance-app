...
-- Also applied automatically on backend startup via ensurePerformanceIndexes().

-- ─── customers ───────────────────────────────────────────────────────────────
-- email: already indexed via UNIQUE constraint on customers.email
-- username: already indexed via UNIQUE constraint on customers.username
...
-- ─── countries / blogs (portal list filters) ─────────────────────────────────
